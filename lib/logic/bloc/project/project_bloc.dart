...
class ProjectBloc extends Bloc<ProjectEvent, ProjectState> {
  ProjectBloc({
    ...
    on<ProjectActivitiesSubscriptionRequested>(
        _onActivitiesSubscriptionRequested);
    on<ProjectTaskGroupsSubscriptionRequested>(
        _onTaskGroupsSubscriptionRequested);
    on<ProjectNoteGroupsSubscriptionRequested>(
        _onNoteGroupsSubscriptionRequested);
  }
